    ...
    with open("titanic/train.csv") as f:
        ...
        for row in reader:
            ...
            if row[4] == "":
                ...
                newList.append(0 if row[4] == "male" else 1)
...
'''
def loadData(validationSet=False):
    X_train = []
    Y_train = []
    X_test  = []
    Y_test  = []
    X_valid = []
    Y_valid = []
    size = getDataSize("titanic/train.csv")
    if validationSet:
        size /= 3
    else:
        size /= 2
    ...
    with open("titanic/test.csv") as f:
        ...
        for row in reader:
            ...
            if row[3] == "":
                ...
                newList.append(0 if row[3] == "male" else 1)
